  ...
  <div class="card md:space-x-2 space-x-0 space-y-3 md:space-y-0 md:flex-row flex-col sm:static flex md:items-center justify-content-center justify-between py-5 lg:px-6col md:px-[100px] px-4">
    ...
    <div class="card flex flex-column md:flex-row gap-3">
        <InputGroup>
            ...
            <InputText v-model="value" placeholder="Search" class="rounded-r border-transparent hover:ring-primario-300 focus:ring-primario-200 bg-primario-100/50 md:w-14rem min-w-2col">
        ...
        <InputGroup>
          ...
          <TreeSelect v-model="selectedCategory" :options="cities" optionLabel="name" placeholder="Seleziona Categoria" class="rounded-r !hover:ring-primario-300 !focus:ring-primario-300 bg-primario-100/50 text-black md:w-14rem min-w-2col"/>
        </InputGroup>
        ...
        <InputGroup>
          ...
          <TreeSelect v-model="selectedCity1" :options="cities" optionLabel="name" placeholder="Seleziona Città" class="rounded-r !hover:ring-primario-300 !focus:ring-primario-300 bg-primario-100/50 text-black md:w-14rem min-w-2col"/>
        </InputGroup>
        </div>
  </div>
