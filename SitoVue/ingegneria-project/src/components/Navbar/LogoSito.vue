<template>
    <RouterLink to="/">
        <div
            ...
            class="mt-1 flex content-evenly rounded bg-inherit px-3 font-bold hover:bg-primario-400 hover:ring-2 hover:ring-slate-300/80 md:items-center md:px-0 md:pb-2"
        >
