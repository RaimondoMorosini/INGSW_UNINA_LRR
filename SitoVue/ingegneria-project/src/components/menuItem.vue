...
const props = defineProps({
    ...
    intent:{
        type: String,
        validator: (value) => ['primario', 'secondario', 'successo', 'danger', 'warning', 'text'].includes(value),
        default: 'secondario',
    }   
});
...
const menuItemClass = computed (() => {
    return cva ( "inline-flex items-center justify-center min-h-[32px] px-3 py-o.5 text-sm font-semibold  text-white ",
    {
        variants:{
            intent: {
