<template>
  <div
    ...
    <InputGroup class="h-14 w-[100%] lg:w-[33%]">
      ...
      <!--id="cerca"-->
      <InputText v-model="nomeProdottoCercato" placeholder="Search"
    ...
    <InputGroup class="h-14 w-[100%] lg:w-[33%]">
      ...
      <TreeSelect id="idCategoria" v-model="selectedCategory" :options="nodes" option-label="name"
    ...
    <button class="h-14 w-[100%] rounded bg-primario-100 text-white lg:w-[10%]" @click="setAsteRicercate">
      Cerca aste
    </button>
  </div>
  ...
  <AstePerRicerca v-else :propAste="aste" :propLoading="isLoading" :propNumeroAste="numeroAsteTotali"
    :propCategoriaCercata="categoriaDaCercare" :propProdottoCercato="nomeProdottoCercato"
...
.p-multiselect-item {
  /* Aggiungi qui le modifiche di stile desiderate */
  /* Ad esempio, modifica il colore di sfondo */
  background-color: #a11e1e !important;
  /* Modifica la dimensione del quadrato */
  width: 16px !important;
  height: 16px !important;
  /* Aggiungi bordi arrotondati */
  border-radius: 4px !important;
  /* Aggiungi spazio tra il quadrato e il testo */
  margin-right: 8px !important; /* Puoi modificare questo valore in base alle tue esigenze */
}
