              ...
              <div class="grid-nogutter grid">
                ...
                >
                  ...
                  >
                    ...
                    <div class="flex-column justify-content-between md:align-items-center flex flex-1 gap-4 md:flex-row">
                      <div class="md:flex-column justify-content-between align-items-start flex flex-row gap-2">
                        <div>
                          ...
                          <div class="text-900 mt-2 text-lg font-medium titolo-articolo">{{ item.nome }}</div>
                      ...
                      <div class="flex-column md:align-items-end flex gap-5">
                        <div class="contenitore-bottone flex flex-row-reverse gap-2 bg-primario-100 md:flex-row">
                          <Button 
                            @click="apriUnNuovoTab(item.idAsta)"
