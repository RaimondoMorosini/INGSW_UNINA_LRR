<template>
    ...
    <div class="barraRicerca" :style="{ border: bordoBarra, 'border-bottom': bordoBarraBottom }"
        @mouseover="hoverBarra(true)" @mouseleave="hoverBarra(false)">
        <div class=" outputBarra">
            <img src="../assets/Icon/lente.svg" class="iconaRicerca" />
            <input style="color: black" type="text" placeholder="Iphone,Dyson.." class="inputRicerca" @click="focusBarra"
...
export default {
    ...
    data() {
        ...
        return {
            ...
            cliccato: false,
            bordoBarra: '2px solid black',
            bordoBarraBottom: '2px solid black',
            coloreEtichetta: 'black'
        };
    },
