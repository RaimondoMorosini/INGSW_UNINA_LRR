...
=======
    <div class="mx-auto my-2.5 flex w-[80%] flex-col gap-3 rounded px-2 py-1">
        <div class="flex flex-col">
            <Dropdown
                @change="onClickOpzione()"
                v-model="opzioneSelezionata"
                :options="opzioniNotifiche"
                optionLabel="name"
...
const props = defineProps(['numeroNotificheNonLette']);
