<template>
  <div class="flex flex-col gap-3 px-3 ">
    <div class="user-info-photo flex w-full flex-row justify-between items-center bg-slate-100 rounded px-3 py-3 space-x-5">
            <div class="flex flex-row space-x-1">
                <img :src="user.picture" alt="Profile Picture" class="rounded-full w-20 h-20 border-primario-200" />
                <div class="User info">
