    ...
    <div class="flex flex-row justify-between items-center fluid w-screen bg-zinc-200 rounded-lg shadow-md p-8">
        ...
        <div class="inline">
            ...
            <div class="image-container ">
                <img v-if="imageURL?.value !=null" :src="imageURL" alt="preview-image" class="preview-image overflow-hidden rounded-full"/>
                ...
                <form>
                    ...
                    <div class="my-6">
                        <FloatLabel variant="on">
                            ...
                            <InputText type="bio" v-model="newbio" id="bio" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                        </FloatLabel>
                    </div>
                    <div class="my-6">
                        <FloatLabel variant="on">
...
function handleImageUpload(event) {
  ...
  if (file && file.type.startsWith("image/")) {
    ...
    reader.onload = () => {
      imageURL.value = reader.result; // Use reader.result to save to the database
    };
...
function handleSubmit() {
  if (imageURL.value) {
    // Save `imageURL.value` to the database here
    console.log("Image URL to save:", imageURL.value);
    alert("Image URL is ready to save to the database.");
  } else {
